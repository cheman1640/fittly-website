...
const D = {
  ...
  "<b>14 days free</b> or 75 try-ons, no card · then pay per use":
    ["<b>14 Tage gratis</b> oder 75 Anproben, ohne Karte · danach zahlst du pro Nutzung",
     "<b>14 jours gratuits</b> ou 75 essayages, sans carte · ensuite vous payez à l'usage",
  ...
  "You start with 14 days free or 75 try-ons, whichever comes first, no card. After that, installing is still free and there is no required monthly fee: on the Free plan you pay $0.35 per try-on used, with a monthly spend cap you define. As your volume grows, Starter ($9/mo) lowers the rate to $0.22 and Growth ($19/mo) to $0.18, with no try-on limits. Size recommendation comes with Starter and Growth and is never metered there, so it never costs you a generation; the Free plan is try-on only. Standard try-ons are also cached, so repeated results are served at no extra cost.":
    ["Du startest mit 14 Tagen gratis oder 75 Anproben, je nachdem was zuerst eintritt, ohne Karte. Danach ist die Installation weiterhin kostenlos und es gibt keine Pflicht-Monatsgebühr: Im Free-Plan zahlst du 0,35 $ pro genutzter Anprobe, mit einem Ausgabenlimit, das du festlegst. Wächst dein Volumen, senkt Starter (9 $/Mon.) den Tarif auf 0,22 $ und Growth (19 $/Mon.) auf 0,18 $, ohne Anprobe-Limits. Die Größenempfehlung gehört zu Starter und Growth und wird dort nie abgerechnet, kostet dich also nie eine Generierung; der Free-Plan ist reine Anprobe. Standard-Anproben werden zudem gecacht, sodass wiederholte Ergebnisse ohne Zusatzkosten ausgeliefert werden.",
     "Vous commencez avec 14 jours gratuits ou 75 essayages, au premier des deux, sans carte. Ensuite l'installation reste gratuite et aucun abonnement mensuel n'est obligatoire : sur le plan Free vous payez 0,35 $ par essayage utilisé, avec un plafond de dépenses que vous définissez. Quand votre volume grandit, Starter (9 $/mois) baisse le tarif à 0,22 $ et Growth (19 $/mois) à 0,18 $, sans limite d'essayages. La recommandation de taille est incluse dans Starter et Growth et n'y est jamais facturée, elle ne vous coûte donc jamais une génération ; le plan Free est un essayage seul. Les essayages standards sont en plus mis en cache, donc les résultats répétés sont servis sans frais supplémentaires.",
     "Você começa com 14 dias grátis ou 75 provas, o que vier primeiro, sem cartão. Depois a instalação continua gratuita e não há taxa mensal obrigatória: no plano Free você paga US$ 0,35 por prova usada, com um limite de gasto que você define. Conforme seu volume cresce, o Starter (US$ 9/mês) reduz a tarifa para US$ 0,22 e o Growth (US$ 19/mês) para US$ 0,18, sem limite de provas. A recomendação de tamanho vem com Starter e Growth e ali nunca é cobrada por uso, então nunca gasta uma geração; o plano Free é só provador. As provas padrão ainda ficam em cache, então resultados repetidos são entregues sem custo extra."],
  ...
  "Size recommendation computed from each garment's real measurements, included and never metered on Starter and Growth":
    ["Größenempfehlung aus den echten Maßen jedes Kleidungsstücks, in Starter und Growth enthalten und dort nie abgerechnet",
     "Recommandation de taille calculée sur les mesures réelles de chaque vêtement, incluse dans Starter et Growth et jamais facturée",
     "Recomendação de tamanho calculada com as medidas reais de cada peça, incluída no Starter e no Growth e nunca cobrada por uso"],

...
const APPS = [
  {
    ...
    pago: "$7,99 · hasta 10 tablas", pagoEn: "$7.99 · up to 10 charts", precioNota: "cargos extra según volumen de pedidos", precioNotaEn: "extra charges based on order volume",
  ...
  },
  {
    ...
    pago: "$19,99 · 100 pruebas/mes", pagoEn: "$19.99 · 100 try-ons/mo", precioNota: "excedente $0,17 por prueba", precioNotaEn: "$0.17 per extra try-on",
  ...
  },
  {
    ...
    pago: "$33 · 200 pruebas/mes", pagoEn: "$33 · 200 try-ons/mo", precioNota: "sin excedente declarado", precioNotaEn: "no overage stated",
  ...
  },
  {
    ...
    pruebaPrevia: "15 try-ons gratis en el editor, antes de elegir plan", pruebaPreviaEn: "15 free try-ons in the editor, before picking a plan",
    pago: "$9 · sin límite de pruebas", pagoEn: "$9 · no try-on limit", precioNota: "más $0,22 por try-on usado", precioNotaEn: "plus $0.22 per try-on used",
    es: "La nuestra, y la más nueva de la lista. El planteo es distinto: el probador y la recomendación de talla no son una función principal y un extra, sino <strong>las dos mitades del mismo widget</strong>. El cliente ve la prenda puesta, con su foto o con 8 tipos de cuerpo, y en el mismo flujo recibe su talla calculada con las medidas reales de esa prenda. La recomendación de talla está incluida en <strong>todos los planes</strong>, Free incluido, y nunca se cobra por uso, así que aconsejar una talla no gasta una generación. Los try-ons estándar además <strong>se cachean</strong>: una prenda ya renderizada sobre un tipo de cuerpo se reutiliza, así que las vistas repetidas no vuelven a cobrar. Por eso una prueba cobrada acá no es la misma unidad que una prueba contada por una app que mide cada vista. El widget está en <strong>cinco idiomas</strong> (español, inglés, portugués, alemán y francés), siguiendo el idioma que tu tienda ya le muestra a cada visitante. Antes de elegir plan pruebas 15 try-ons gratis sobre tus propios productos, dentro del editor de temas de Shopify y sin tarjeta; esas pruebas solo las ves tú, y el widget sale al público cuando activas un plan. No hay trial con fecha de vencimiento. La instalación es gratuita y sin fee mensual: en el plan Free pagas $0,35 por try-on usado, y los planes de $9 y $19 al mes bajan esa tarifa.",
    en: "Ours, and the newest on the list. The premise is different: the try-on and the size recommendation are not a main feature plus an extra, they are <strong>the two halves of the same widget</strong>. The shopper sees the garment on, with their own photo or one of 8 body types, and in the same flow gets a size computed from that garment's real measurements. Size recommendation is included on <strong>every plan</strong>, Free included, and is never metered, so advising a size never costs a generation. Standard try-ons are also <strong>cached</strong>: a garment already rendered on a body type is reused, so repeat views do not bill again. That means a billed try-on here is not the same unit as a try-on counted by an app that meters every view. The widget ships in <strong>five languages</strong> (Spanish, English, Portuguese, German and French), following the language your store already shows each visitor. Before picking a plan you run 15 free try-ons on your own products, inside the Shopify theme editor and with no card; those previews are private to you, and the widget goes live for shoppers once you activate a plan. There is no time-limited trial. Installing is free with no monthly fee: on the Free plan you pay $0.35 per try-on used, and the $9 and $19 monthly plans lower that rate.",
  },
];
...
const T = {
  es: {
    ...
    aviso: "Ojo con leer esa última columna como un ranking de precio: los cuatro números no significan lo mismo. Kiwi, GenLook y STILARO cobran un fee mensual con un cupo incluido; Fittly cobra un fee más bajo y además por cada try-on usado. Cuál sale más barata depende de cuántas pruebas haga tu tienda al mes, así que conviene estimar tu volumen antes de comparar. Sobre probar antes de pagar: Fittly no tiene trial con fecha, da 15 try-ons gratis dentro del editor de temas para que veas el resultado en tus propios productos el primer día; Kiwi da 14 días de prueba en sus planes pagados.",
    ...
    faq: [
      ...
      ["¿Hay alguna app de probador virtual gratis para Shopify?", "Las cuatro tienen plan gratis, pero significan cosas distintas. Kiwi te deja publicar hasta 3 tablas de tallas gratis. GenLook da 10 pruebas al mes y STILARO 30. Fittly no tiene trial con fecha: te da 15 try-ons gratis en el editor de temas para probarlo, y su plan Free no tiene fee mensual y cobra $0,35 por try-on usado, con un tope de gasto que defines tú."],
      ["¿Cuánto cuesta un probador virtual en Shopify?", "Depende del modelo de cobro, y los cuatro son distintos. Kiwi parte en $7,99 al mes por hasta 10 tablas, pero no incluye probador y advierte cargos extra según tu volumen de pedidos. Entre las que sí traen probador: GenLook cobra $19,99 al mes con 100 pruebas incluidas y $0,17 por cada prueba extra; STILARO cobra $33 al mes con 200 pruebas incluidas; Fittly cobra $9 al mes sin límite de pruebas más $0,22 por try-on usado, o $0 al mes pagando $0,35 por try-on. Con poco volumen el modelo por uso sale más barato y con mucho volumen los cupos mensuales suelen ganar, así que estima tus pruebas al mes antes de comparar."],
  ...
  en: {
    ...
    aviso: "Do not read that last column as a price ranking: the four numbers do not mean the same thing. Kiwi, GenLook and STILARO charge a monthly fee with an included allowance; Fittly charges a lower fee plus a cost per try-on used. Which one is cheaper depends on how many try-ons your store runs each month, so it is worth estimating your volume before comparing. On trying before paying: Fittly has no time-limited trial, it gives 15 free try-ons inside the theme editor so you see the result on your own products on day one; Kiwi gives a 14-day trial on its paid plans.",
    ...
    faq: [
      ...
      ["Is there a free virtual try-on app for Shopify?", "All four have a free plan, but they mean different things. Kiwi lets you publish up to 3 size charts for free. GenLook gives 10 try-ons a month and STILARO gives 30. Fittly has no time-limited trial: it gives 15 free try-ons in the theme editor to evaluate it, and its Free plan has no monthly fee and charges $0.35 per try-on used, with a spend cap you define."],
      ["How much does a virtual try-on cost on Shopify?", "It depends on the billing model, and all four are different. Kiwi starts at $7.99 a month for up to 10 size charts, but it has no try-on and warns of extra charges based on your order volume. Among the ones that do have a try-on: GenLook charges $19.99 a month with 100 try-ons included and $0.17 per extra try-on; STILARO charges $33 a month with 200 try-ons included; Fittly charges $9 a month with no try-on limit plus $0.22 per try-on used, or $0 a month paying $0.35 per try-on. At low volume the pay-per-use model tends to be cheaper and at high volume the monthly allowances usually win, so estimate your monthly try-ons before comparing."],
...
function pagina(t, arriba) {
  ...
  const filas = APPS.map((a) => {
    const x = A(a);
    const nota = t.lang === "es" ? a.precioNota : a.precioNotaEn;
    return `        <tr><td><a href="https://apps.shopify.com/${a.slug}" target="_blank" rel="noopener">${a.nombre}</a></td><td>${x.r} (${x.e}★)</td><td>${x.l}</td><td>${x.g}</td><td>${x.p}<span class="nota">${nota}</span></td></tr>`;
  }).join("\n");
  ...
  const itemList = {
    ...
    itemListElement: APPS.map((a, i) => ({
      ...
      item: {
        ...
        offers: { "@type": "Offer", price: a.precioNum, priceCurrency: "USD", description: (t.lang === "es" ? a.pago + ", " + a.precioNota : a.pagoEn + ", " + a.precioNotaEn) },
...
<head>
  ...
  <style>
${CSS}
    .doc td .nota { display: block; font-size: 12px; font-weight: 600; color: var(--faint); margin-top: 3px; }
    .aviso { background: var(--surface); border: 1px solid var(--border); border-radius: 14px; padding: 16px 20px; font-size: 13.5px; font-weight: 500; color: var(--muted); line-height: 1.65; margin-top: 4px; }

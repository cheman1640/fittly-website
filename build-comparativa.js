...
const APPS = [
  ...
  },
  {
    ...
    es: "La nuestra, y la más nueva de la lista. El planteo es distinto: el probador y la recomendación de talla no son una función principal y un extra, sino <strong>las dos mitades del mismo widget</strong>. El cliente ve la prenda puesta, con su foto o con 8 tipos de cuerpo, y en el mismo flujo recibe su talla calculada con las medidas reales de esa prenda. La recomendación de talla <strong>nunca se cobra por uso</strong>, y el widget está en <strong>cinco idiomas</strong> (español, inglés, portugués, alemán y francés), siguiendo el idioma que tu tienda ya le muestra a cada visitante. Parte con 14 días gratis o 75 pruebas, lo que se cumpla antes y sin tarjeta. Terminado el trial la instalación sigue siendo gratuita y sin fee mensual: en el plan Free pagas $0,35 por try-on usado, y los planes de $9 y $19 al mes bajan esa tarifa.",

...
const APPS = [
  ...
  },
  {
    ...
    es: "La nuestra, y la más nueva de la lista. El planteo es distinto: el probador y la recomendación de talla no son una función principal y un extra, sino <strong>las dos mitades del mismo widget</strong>. El cliente ve la prenda puesta, con su foto o con 8 tipos de cuerpo, y en el mismo flujo recibe su talla calculada con las medidas reales de esa prenda. La recomendación de talla viene en los planes de $9 y $19 y ahí <strong>nunca se cobra por uso</strong>, así que aconsejar una talla no gasta una generación; el plan Free es solo probador. Los try-ons estándar además <strong>se cachean</strong>: una prenda ya renderizada sobre un tipo de cuerpo se reutiliza, así que las vistas repetidas no vuelven a cobrar. Por eso una prueba cobrada acá no es la misma unidad que una prueba contada por una app que mide cada vista. El widget está en <strong>cinco idiomas</strong> (español, inglés, portugués, alemán y francés), siguiendo el idioma que tu tienda ya le muestra a cada visitante. Parte con 14 días gratis o 75 pruebas, lo que se cumpla antes y sin tarjeta. Terminado el trial la instalación sigue siendo gratuita y sin fee mensual: en el plan Free pagas $0,35 por try-on usado, y los planes de $9 y $19 al mes bajan esa tarifa.",
    en: "Ours, and the newest on the list. The premise is different: the try-on and the size recommendation are not a main feature plus an extra, they are <strong>the two halves of the same widget</strong>. The shopper sees the garment on, with their own photo or one of 8 body types, and in the same flow gets a size computed from that garment's real measurements. Size recommendation comes with the $9 and $19 plans and is <strong>never metered</strong> there, so advising a size never costs a generation; the Free plan is try-on only. Standard try-ons are also <strong>cached</strong>: a garment already rendered on a body type is reused, so repeat views do not bill again. That means a billed try-on here is not the same unit as a try-on counted by an app that meters every view. The widget ships in <strong>five languages</strong> (Spanish, English, Portuguese, German and French), following the language your store already shows each visitor. It starts with 14 days free or 75 try-ons, whichever comes first, no card. Once the trial ends, installing is still free with no monthly fee: on the Free plan you pay $0.35 per try-on used, and the $9 and $19 monthly plans lower that rate.",
  },
];
...
const T = {
  ...
  en: {
    ...
    aviso: "Do not read that last column as a price ranking: the four numbers do not mean the same thing. Kiwi, GenLook and STILARO charge a monthly fee with an included allowance; Fittly charges a lower fee plus a cost per try-on used. Which one is cheaper depends on how many try-ons your store runs each month, so it is worth estimating your volume before comparing. On free trials: Fittly gives 14 days or 75 try-ons with no card, and Kiwi gives 14 days on its paid plans.",
    ...
    faq: [
      ...
      ["Is there a free virtual try-on app for Shopify?", "All four have a free plan, but they mean different things. Kiwi lets you publish up to 3 size charts for free. GenLook gives 10 try-ons a month and STILARO gives 30. Fittly starts with a 14-day or 75 try-on trial and then lands on its Free plan, which has no monthly fee and charges $0.35 per try-on used, with a spend cap you define."],
